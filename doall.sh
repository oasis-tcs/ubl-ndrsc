...
bash packageGovernance.sh $1 cnd01 $3 $4 $5 $6       | tee -a $1/ndr.console.$3.txt
UBLGovReturn=${PIPESTATUS[0]}
#echo UBL 2.1 JSON 2.0...                                | tee -a $1/ndr.console.$3.txt
#bash packageUBLJSON.sh $1 2.1 2.0 cnd01 $3 $4 $5 $6 | tee -a $1/ndr.console.$3.txt
#UBL21Return=${PIPESTATUS[0]}
#echo UBL 2.2 JSON 1.0...                                | tee -a $1/ndr.console.$3.txt
#bash packageUBLJSON.sh $1 2.2 1.0 cnd01 $3 $4 $5 $6 | tee -a $1/ndr.console.$3.txt
#UBL22Return=${PIPESTATUS[0]}
#echo UBL 2.3 JSON 1.0...                                | tee -a $1/ndr.console.$3.txt
#bash packageUBLJSON.sh $1 2.3 1.0 cnd01 $3 $4 $5 $6 | tee -a $1/ndr.console.$3.txt
#UBL23Return=${PIPESTATUS[0]}
#echo UBL NDR 3.1...                                     | tee -a $1/ndr.console.$3.txt
#bash packageUBLNDR.sh $1 cnd01 $3 $4 $5 $6          | tee -a $1/ndr.console.$3.txt
#UBLNDRReturn=${PIPESTATUS[0]}
#echo BDNDR 1.1...                                       | tee -a $1/ndr.console.$3.txt
#bash packageBDNDR11.sh $1 csd03 $3 $4 $5 $6         | tee -a $1/ndr.console.$3.txt
